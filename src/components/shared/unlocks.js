...
export const UNLOCKS = [
  ...
  { rb: 0, icon: "🎁", title: "Bonus bienvenida x2", side: "centro", desc: "Doble ganancia permanente, actívatelo." },
  ...
  { rb: 2, icon: "🤖", title: "Auto-Clicker lvl 1", side: "der", desc: "Automatiza clicks cada 900ms." },
